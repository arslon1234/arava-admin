...
const Index = ({ title, id, data }: propsData) => {
  ...
  const handleSubmit = async (value: any) => {
    ...
    let status;
    if (!id) {
      status = await postDataRegion(value);
    } else {
      const updateData = { ...value, id: id };
      status = await updateDataRegion(updateData);
    }
    ...
    <>
      ...
      >
        ...
        <Form
          ...
          initialValues={{'countryId': data?.countryId ? data?.countryId : undefined}}
          style={{
            display: "flex",
        ...
        >
          ...
          <div>
            ...
            >
              <Select size="large" value={data?.countryId && data?.countryId}>
