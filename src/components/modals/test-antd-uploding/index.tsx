...
const Index = ({ text }: PropsData) => {
  ...
  return (
    <Upload {...props}>
      <Button
        icon={<UploadOutlined />}
        className={text === "brand" ? "w-full px-[96px] text-[18px] py-[27.5px] border border-[#C4C4C4] rounded-[5px]" : "w-full px-[107px]  text-[18px] py-[20px] border border-[#C4C4C4] rounded-[10px] mb-2"}
      >
        Image upload
      </Button>
    </Upload>
